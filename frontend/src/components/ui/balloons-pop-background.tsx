...
export default function BalloonBackground() {
    ...
    useEffect(() => {
        ...
        const resize = () => {
            ...
            // Account for the navbar offset (64px = 4rem)
    ...
    return (
        <div className="fixed inset-0 top-16 z-0 w-full h-[calc(100%-4rem)] overflow-hidden bg-zinc-950 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-zinc-900 via-zinc-950 to-black">
